...
public final class TimingClientMain
{
    public static void main(final String[] args) throws Exception
    {
        ...
        final SocketAddress samplingAddress = fromAddressSpec(RequiredProperties.requiredProperty("flute.test.acceptance.reporting.udp.address", properties));
        final SocketAddress recordingAddress = fromAddressSpec(RequiredProperties.requiredProperty("flute.test.acceptance.reporting.tcp.address", properties));
